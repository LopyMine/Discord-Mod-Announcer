	...
	public void testAnnounceThree() {
		try {
			...
			writer.write("""
						 ...
						 announceToDiscord {
						    linksFormat = VERSIONED
						    priorityPlatform = CURSEFORGE

						    minecraftVersion = "1.20.1"
						    loader = "fabric"

						    modrinthModId = "collision-fix"

						    curseForgeProjectId = 946375
						    curseForgeAPIToken = providers.environmentVariable("CURSEFORGE_API_KEY")
